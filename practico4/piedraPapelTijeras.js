...
function imprimirInstrucciones() {
  ...
  console.log('* Las jugadas validas son "piedra", "papel" o "tijeras"');
...
function determinarGanador(jugadaComputadora, jugadaUsuario) {
  ...
  // Tipo de dato de retorno: string
  // Valor de retorno: 'Gana la computadora', 'Gana el usuario' o 'Empate'
...
function imprimirResultadoJugada(jugadaComputadora, jugadaUsuario, resultado) {
  ...
  // Valor que recibe ([resultado]): 'Gana la computadora', 'Gana el usuario' o 'Empate'
  // Tipo de dato de retorno: undefined
